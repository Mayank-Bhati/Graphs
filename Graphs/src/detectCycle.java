...
public class detectCycle {
    ...
    static boolean detect(int node, int[] vis, ArrayList<ArrayList<Integer>> adj){
    ...
    static boolean DFS(int node, int[] vis, ArrayList<ArrayList<Integer>> adj) {
        if (vis[node] != 1) {
    ...
    static boolean BFS(int node, int[] vis, ArrayList<ArrayList<Integer>> adj) {
